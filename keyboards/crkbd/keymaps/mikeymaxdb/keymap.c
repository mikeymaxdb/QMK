...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ADJUST] = LAYOUT(
            _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, _______, _______, _______, QWERTY,  COLEMAK, _______,
            RESET,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, _______, KC_MPLY, KC_VOLD, KC_VOLU, KC_MNXT, _______,
